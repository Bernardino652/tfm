...
# -*- coding: utf-8 -*-
"""
script: corea_del_sur.py
Generador de Datos Turísticos de Corea Sur (2019-2023).

Este script genera un conjunto de datos reales y simulados que representa el flujo turístico
de visitantes de Corea del Sur a España durante el período 2019-2023. Simula patrones 
