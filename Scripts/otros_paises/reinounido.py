...
# -*- coding: utf-8 -*-
"""
script: reinounido.py
Generador de Datos Turísticos de Reino Unido (2019-2023).

Este script genera un conjunto de datos reales y simulados que representa el flujo turístico
de visitantes de Reino Unido a España durante el período 2019-2023. Simula patrones 
