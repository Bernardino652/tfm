...
# -*- coding: utf-8 -*-
"""
script: republicacheca.py
Generador de Datos Turísticos de Repuiblioca Checa (2019-2023).

Este script genera un conjunto de datos reales y simulados que representa el flujo turístico
de visitantes de Republica Checa a España durante el período 2019-2023. Simula patrones 
